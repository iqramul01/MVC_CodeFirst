    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //Assigning UserName as the UserName
                ...
                if (result.Succeeded)
                {
                    MailMessage m = new MailMessage(new MailAddress("iqramulcs46@gmail.com", "Medicare Registration"), new MailAddress(user.Email));
                    ...
                    smtp.Credentials = new NetworkCredential("iqramulcs46@gmail.com", "Iqramul@46");
                    smtp.EnableSsl = true;
                    smtp.Send(m);
